...
class Fhrp_group_assignmentsEndpoint(Endpoint):
    ...
    def delete(self, objects: Iterable[definitions.FHRPGroupAssignment]) -> bool: ...
    def choices(self) -> dict: ...
    def count(
        self,
        id: Optional[str | int] = None,
...
class L2vpn_terminationsEndpoint(Endpoint):
    def all(self, limit=0, offset=None) -> RecordSet[definitions.L2VPNTermination]: ...
    def get(
        self,
        id: Optional[str | int] = None,
    ...
    @overload
    def create(self, *args: Dict[str, Any]) -> definitions.L2VPNTermination: ...
    @overload
    def create(
        self,
        l2vpn: int,
    ...
    def delete(self, objects: Iterable[definitions.L2VPNTermination]) -> bool: ...
    def choices(self) -> dict: ...
    def count(
        self,
        id: Optional[str | int] = None,
...
class L2vpnsEndpoint(Endpoint):
    ...
    def create(self, *args: Dict[str, Any], **kwargs: Any) -> definitions.L2VPN: ...
    def update(
...
class Service_templatesEndpoint(Endpoint):
    ...
    def delete(self, objects: Iterable[definitions.ServiceTemplate]) -> bool: ...
    def choices(self) -> dict: ...
    def count(
        self,
        id: Optional[str | int] = None,
