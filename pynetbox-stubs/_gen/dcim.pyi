...
class Cable_terminationsEndpoint(Endpoint):
    def all(self, limit=0, offset=None) -> RecordSet[definitions.CableTermination]: ...
    def get(
        self,
    ...
    @overload
    def create(self, *args: Dict[str, Any]) -> definitions.CableTermination: ...
    @overload
    def create(
        self,
        cable: int,
    ...
    def delete(self, objects: Iterable[definitions.CableTermination]) -> bool: ...
